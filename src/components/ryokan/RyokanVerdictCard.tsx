...
function getVerdict(result: ThesisEvalResult): VerdictDisplay {
  if (result.riskFlag === 'reject') {
    return {
      ...
      sublabel: 'Revise before proceeding.',
  ...
  if (result.thesisScore >= 7) {
    return {
      ...
      sublabel: 'Proceed with discipline.',
  ...
  return {
    ...
    sublabel: 'Elevated risk acknowledged.',
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 h-1.5 rounded-none" style={{ backgroundColor: 'var(--bg-elevated)' }}>
          <motion.div
            initial={{ width: 0 }}
      ...
      {/* Ryokan statement */}
      <div
        className="p-3 border-l-2 text-sm italic"
        style={{ borderColor: verdict.color, color: 'var(--text-secondary)', lineHeight: '1.6' }}
      >
